...
## 릴리즈 v1.0.19, 2025-12-27
### 신규 기능
* Snowflake 지원 추가
* Databricks 지원 추가

## 릴리즈 v1.0.17, 2025-11-27
### 버그 수정
* ODBC 에러내용을 표기를 실제 에러내용이 보이도록 수정
* 앱 초기화 및 API 등록관련해서 예외처리 추가 및 로깅추가

## 릴리즈 v1.0.16, 2025-11-25
### 신규 기능
* ODBC 테이블 목록에서 유저 테이블과 뷰만 보이게 수정
